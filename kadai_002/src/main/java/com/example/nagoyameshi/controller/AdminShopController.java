...
public class AdminShopController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
    	...
    	ShopEditForm shopEditForm = new ShopEditForm(shop.getId(),shop.getName(),null,shop.getDescription(),shop.getCapacity(),shop.getPostalCode(),shop.getAddress(),shop.getPhoneNumber());
